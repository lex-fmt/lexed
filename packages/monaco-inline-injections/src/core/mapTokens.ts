import { SEMANTIC_TOKEN_MAP } from './constants'
import type { DecorationCategory, InjectionRange, InjectionZone, SemanticTokens } from './types'
 ...
 * not in `SEMANTIC_TOKEN_MAP` are silently skipped.
 */
