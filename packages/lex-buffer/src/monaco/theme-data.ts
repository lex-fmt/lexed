...
export const RULES: { light: TokenRule[]; dark: TokenRule[] } = {
  light: [
    ...
    { token: 'Reference', foreground: '808080', fontStyle: 'bold' },
    { token: 'ReferenceCitation', foreground: '808080', fontStyle: 'bold' },
    { token: 'ReferenceFootnote', foreground: '808080', fontStyle: 'bold' },
    { token: 'ReferenceAnnotation', foreground: '808080', fontStyle: 'bold' },
  ...
  dark: [
    ...
    { token: 'Reference', foreground: '888888', fontStyle: 'bold' },
    { token: 'ReferenceCitation', foreground: '888888', fontStyle: 'bold' },
    { token: 'ReferenceFootnote', foreground: '888888', fontStyle: 'bold' },
    { token: 'ReferenceAnnotation', foreground: '888888', fontStyle: 'bold' },
